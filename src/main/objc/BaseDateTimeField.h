...
#pragma push_macro("INCLUDE_ALL_BaseDateTimeField")
#ifdef RESTRICT_BaseDateTimeField
#define INCLUDE_ALL_BaseDateTimeField 0
#else
#define INCLUDE_ALL_BaseDateTimeField 1
#endif
#undef RESTRICT_BaseDateTimeField

#if !defined (OrgJodaTimeFieldBaseDateTimeField_) && (INCLUDE_ALL_BaseDateTimeField || defined(INCLUDE_OrgJodaTimeFieldBaseDateTimeField))
...
#pragma pop_macro("INCLUDE_ALL_BaseDateTimeField")
