...
#pragma push_macro("INCLUDE_ALL_AssembledChronology")
#ifdef RESTRICT_AssembledChronology
#define INCLUDE_ALL_AssembledChronology 0
#else
#define INCLUDE_ALL_AssembledChronology 1
#endif
#undef RESTRICT_AssembledChronology

#if !defined (OrgJodaTimeChronoAssembledChronology_) && (INCLUDE_ALL_AssembledChronology || defined(INCLUDE_OrgJodaTimeChronoAssembledChronology))
#define OrgJodaTimeChronoAssembledChronology_

#define RESTRICT_BaseChronology 1
...
#if !defined (OrgJodaTimeChronoAssembledChronology_Fields_) && (INCLUDE_ALL_AssembledChronology || defined(INCLUDE_OrgJodaTimeChronoAssembledChronology_Fields))
...
#pragma pop_macro("INCLUDE_ALL_AssembledChronology")
