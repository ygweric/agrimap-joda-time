...
#pragma push_macro("INCLUDE_ALL_FieldUtils")
#ifdef RESTRICT_FieldUtils
#define INCLUDE_ALL_FieldUtils 0
#else
#define INCLUDE_ALL_FieldUtils 1
#endif
#undef RESTRICT_FieldUtils

#if !defined (OrgJodaTimeFieldFieldUtils_) && (INCLUDE_ALL_FieldUtils || defined(INCLUDE_OrgJodaTimeFieldFieldUtils))
...
#pragma pop_macro("INCLUDE_ALL_FieldUtils")
