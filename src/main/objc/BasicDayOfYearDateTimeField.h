...
//  source: /Users/eric/repos/360-j2objc/joda-time/build/mainTranslationExtraction/org/joda/time/chrono/BasicDayOfYearDateTimeField.java
//

#include "J2ObjC_header.h"

#pragma push_macro("INCLUDE_ALL_BasicDayOfYearDateTimeField")
#ifdef RESTRICT_BasicDayOfYearDateTimeField
#define INCLUDE_ALL_BasicDayOfYearDateTimeField 0
#else
#define INCLUDE_ALL_BasicDayOfYearDateTimeField 1
#endif
#undef RESTRICT_BasicDayOfYearDateTimeField

#if !defined (OrgJodaTimeChronoBasicDayOfYearDateTimeField_) && (INCLUDE_ALL_BasicDayOfYearDateTimeField || defined(INCLUDE_OrgJodaTimeChronoBasicDayOfYearDateTimeField))
...
#pragma pop_macro("INCLUDE_ALL_BasicDayOfYearDateTimeField")
