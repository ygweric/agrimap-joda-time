...
#pragma push_macro("INCLUDE_ALL_DateTimeZone")
#ifdef RESTRICT_DateTimeZone
#define INCLUDE_ALL_DateTimeZone 0
#else
#define INCLUDE_ALL_DateTimeZone 1
#endif
#undef RESTRICT_DateTimeZone

#if !defined (OrgJodaTimeDateTimeZone_) && (INCLUDE_ALL_DateTimeZone || defined(INCLUDE_OrgJodaTimeDateTimeZone))
...
#if !defined (OrgJodaTimeDateTimeZone_LazyInit_) && (INCLUDE_ALL_DateTimeZone || defined(INCLUDE_OrgJodaTimeDateTimeZone_LazyInit))
...
#pragma pop_macro("INCLUDE_ALL_DateTimeZone")
