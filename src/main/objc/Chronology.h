...
#pragma push_macro("INCLUDE_ALL_Chronology")
#ifdef RESTRICT_Chronology
#define INCLUDE_ALL_Chronology 0
#else
#define INCLUDE_ALL_Chronology 1
#endif
#undef RESTRICT_Chronology

#if !defined (OrgJodaTimeChronology_) && (INCLUDE_ALL_Chronology || defined(INCLUDE_OrgJodaTimeChronology))
...
#pragma pop_macro("INCLUDE_ALL_Chronology")
