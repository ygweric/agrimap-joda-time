...
#pragma push_macro("INCLUDE_ALL_MutableDateTime")
#ifdef RESTRICT_MutableDateTime
#define INCLUDE_ALL_MutableDateTime 0
#else
#define INCLUDE_ALL_MutableDateTime 1
#endif
#undef RESTRICT_MutableDateTime

#if !defined (OrgJodaTimeMutableDateTime_) && (INCLUDE_ALL_MutableDateTime || defined(INCLUDE_OrgJodaTimeMutableDateTime))
...
#define RESTRICT_ReadWritableDateTime 1
...
#if !defined (OrgJodaTimeMutableDateTime_Property_) && (INCLUDE_ALL_MutableDateTime || defined(INCLUDE_OrgJodaTimeMutableDateTime_Property))
...
#pragma pop_macro("INCLUDE_ALL_MutableDateTime")
