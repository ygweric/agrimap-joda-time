...
#pragma push_macro("INCLUDE_ALL_MutablePeriod")
#ifdef RESTRICT_MutablePeriod
#define INCLUDE_ALL_MutablePeriod 0
#else
#define INCLUDE_ALL_MutablePeriod 1
#endif
#undef RESTRICT_MutablePeriod

#if !defined (OrgJodaTimeMutablePeriod_) && (INCLUDE_ALL_MutablePeriod || defined(INCLUDE_OrgJodaTimeMutablePeriod))
#define OrgJodaTimeMutablePeriod_

#define RESTRICT_BasePeriod 1
#define INCLUDE_OrgJodaTimeBaseBasePeriod 1
#include "BasePeriod.h"

#define RESTRICT_ReadWritablePeriod 1
...
#pragma pop_macro("INCLUDE_ALL_MutablePeriod")
