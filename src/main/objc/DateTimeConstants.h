...
#pragma push_macro("INCLUDE_ALL_DateTimeConstants")
#ifdef RESTRICT_DateTimeConstants
#define INCLUDE_ALL_DateTimeConstants 0
#else
#define INCLUDE_ALL_DateTimeConstants 1
#endif
#undef RESTRICT_DateTimeConstants

#if !defined (OrgJodaTimeDateTimeConstants_) && (INCLUDE_ALL_DateTimeConstants || defined(INCLUDE_OrgJodaTimeDateTimeConstants))
...
#pragma pop_macro("INCLUDE_ALL_DateTimeConstants")
