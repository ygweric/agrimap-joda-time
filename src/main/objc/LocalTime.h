...
#pragma push_macro("INCLUDE_ALL_LocalTime")
#ifdef RESTRICT_LocalTime
#define INCLUDE_ALL_LocalTime 0
#else
#define INCLUDE_ALL_LocalTime 1
#endif
#undef RESTRICT_LocalTime

#if !defined (OrgJodaTimeLocalTime_) && (INCLUDE_ALL_LocalTime || defined(INCLUDE_OrgJodaTimeLocalTime))
...
#if !defined (OrgJodaTimeLocalTime_Property_) && (INCLUDE_ALL_LocalTime || defined(INCLUDE_OrgJodaTimeLocalTime_Property))
...
#pragma pop_macro("INCLUDE_ALL_LocalTime")
