...
#pragma push_macro("INCLUDE_ALL_BaseDateTime")
#ifdef RESTRICT_BaseDateTime
#define INCLUDE_ALL_BaseDateTime 0
#else
#define INCLUDE_ALL_BaseDateTime 1
#endif
#undef RESTRICT_BaseDateTime

#if !defined (OrgJodaTimeBaseBaseDateTime_) && (INCLUDE_ALL_BaseDateTime || defined(INCLUDE_OrgJodaTimeBaseBaseDateTime))
#define OrgJodaTimeBaseBaseDateTime_

#define RESTRICT_AbstractDateTime 1
...
#pragma pop_macro("INCLUDE_ALL_BaseDateTime")
