...
#pragma push_macro("INCLUDE_ALL_DateTimeField")
#ifdef RESTRICT_DateTimeField
#define INCLUDE_ALL_DateTimeField 0
#else
#define INCLUDE_ALL_DateTimeField 1
#endif
#undef RESTRICT_DateTimeField

#if !defined (OrgJodaTimeDateTimeField_) && (INCLUDE_ALL_DateTimeField || defined(INCLUDE_OrgJodaTimeDateTimeField))
...
#pragma pop_macro("INCLUDE_ALL_DateTimeField")
