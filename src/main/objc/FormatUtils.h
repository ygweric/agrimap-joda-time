...
#pragma push_macro("INCLUDE_ALL_FormatUtils")
#ifdef RESTRICT_FormatUtils
#define INCLUDE_ALL_FormatUtils 0
#else
#define INCLUDE_ALL_FormatUtils 1
#endif
#undef RESTRICT_FormatUtils

#if !defined (OrgJodaTimeFormatFormatUtils_) && (INCLUDE_ALL_FormatUtils || defined(INCLUDE_OrgJodaTimeFormatFormatUtils))
...
#pragma pop_macro("INCLUDE_ALL_FormatUtils")
