...
#pragma push_macro("INCLUDE_ALL_AbstractReadableInstantFieldProperty")
#ifdef RESTRICT_AbstractReadableInstantFieldProperty
#define INCLUDE_ALL_AbstractReadableInstantFieldProperty 0
#else
#define INCLUDE_ALL_AbstractReadableInstantFieldProperty 1
#endif
#undef RESTRICT_AbstractReadableInstantFieldProperty

#if !defined (OrgJodaTimeFieldAbstractReadableInstantFieldProperty_) && (INCLUDE_ALL_AbstractReadableInstantFieldProperty || defined(INCLUDE_OrgJodaTimeFieldAbstractReadableInstantFieldProperty))
...
#pragma pop_macro("INCLUDE_ALL_AbstractReadableInstantFieldProperty")
