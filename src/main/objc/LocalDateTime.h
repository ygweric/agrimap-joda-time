...
#pragma push_macro("INCLUDE_ALL_LocalDateTime")
#ifdef RESTRICT_LocalDateTime
#define INCLUDE_ALL_LocalDateTime 0
#else
#define INCLUDE_ALL_LocalDateTime 1
#endif
#undef RESTRICT_LocalDateTime

#if !defined (OrgJodaTimeLocalDateTime_) && (INCLUDE_ALL_LocalDateTime || defined(INCLUDE_OrgJodaTimeLocalDateTime))
#define OrgJodaTimeLocalDateTime_

#define RESTRICT_BaseLocal 1
...
#if !defined (OrgJodaTimeLocalDateTime_Property_) && (INCLUDE_ALL_LocalDateTime || defined(INCLUDE_OrgJodaTimeLocalDateTime_Property))
...
#pragma pop_macro("INCLUDE_ALL_LocalDateTime")
