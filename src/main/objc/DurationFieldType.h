...
#pragma push_macro("INCLUDE_ALL_DurationFieldType")
#ifdef RESTRICT_DurationFieldType
#define INCLUDE_ALL_DurationFieldType 0
#else
#define INCLUDE_ALL_DurationFieldType 1
#endif
#undef RESTRICT_DurationFieldType

#if !defined (OrgJodaTimeDurationFieldType_) && (INCLUDE_ALL_DurationFieldType || defined(INCLUDE_OrgJodaTimeDurationFieldType))
...
#pragma pop_macro("INCLUDE_ALL_DurationFieldType")
