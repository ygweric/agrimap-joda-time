...
#pragma push_macro("INCLUDE_ALL_DateTimeUtils")
#ifdef RESTRICT_DateTimeUtils
#define INCLUDE_ALL_DateTimeUtils 0
#else
#define INCLUDE_ALL_DateTimeUtils 1
#endif
#undef RESTRICT_DateTimeUtils
...
#if !defined (OrgJodaTimeDateTimeUtils_) && (INCLUDE_ALL_DateTimeUtils || defined(INCLUDE_OrgJodaTimeDateTimeUtils))
...
inline id<OrgJodaTimeDateTimeUtils_MillisProvider> OrgJodaTimeDateTimeUtils_get_SYSTEM_MILLIS_PROVIDER();
/*! INTERNAL ONLY - Use accessor function from above. */
FOUNDATION_EXPORT id<OrgJodaTimeDateTimeUtils_MillisProvider> OrgJodaTimeDateTimeUtils_SYSTEM_MILLIS_PROVIDER;
J2OBJC_STATIC_FIELD_OBJ_FINAL(OrgJodaTimeDateTimeUtils, SYSTEM_MILLIS_PROVIDER, id<OrgJodaTimeDateTimeUtils_MillisProvider>)
...
#if !defined (OrgJodaTimeDateTimeUtils_MillisProvider_) && (INCLUDE_ALL_DateTimeUtils || defined(INCLUDE_OrgJodaTimeDateTimeUtils_MillisProvider))
...
#if !defined (OrgJodaTimeDateTimeUtils_SystemMillisProvider_) && (INCLUDE_ALL_DateTimeUtils || defined(INCLUDE_OrgJodaTimeDateTimeUtils_SystemMillisProvider))
...
#if !defined (OrgJodaTimeDateTimeUtils_FixedMillisProvider_) && (INCLUDE_ALL_DateTimeUtils || defined(INCLUDE_OrgJodaTimeDateTimeUtils_FixedMillisProvider))
...
#if !defined (OrgJodaTimeDateTimeUtils_OffsetMillisProvider_) && (INCLUDE_ALL_DateTimeUtils || defined(INCLUDE_OrgJodaTimeDateTimeUtils_OffsetMillisProvider))
...
#pragma pop_macro("INCLUDE_ALL_DateTimeUtils")
