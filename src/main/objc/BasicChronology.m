...
- (NSString *)description {
  JavaLangStringBuilder *sb = new_JavaLangStringBuilder_initWithInt_(60);
...
- (void)assembleWithOrgJodaTimeChronoAssembledChronology_Fields:(OrgJodaTimeChronoAssembledChronology_Fields *)fields {
  ((OrgJodaTimeChronoAssembledChronology_Fields *) nil_chk(fields))->millis_ = OrgJodaTimeChronoBasicChronology_cMillisField;
  fields->seconds_ = OrgJodaTimeChronoBasicChronology_cSecondsField;
  fields->minutes_ = OrgJodaTimeChronoBasicChronology_cMinutesField;
  fields->hours_ = OrgJodaTimeChronoBasicChronology_cHoursField;
  fields->halfdays_ = OrgJodaTimeChronoBasicChronology_cHalfdaysField;
  fields->days_ = OrgJodaTimeChronoBasicChronology_cDaysField;
  fields->weeks_ = OrgJodaTimeChronoBasicChronology_cWeeksField;
  fields->millisOfSecond_ = OrgJodaTimeChronoBasicChronology_cMillisOfSecondField;
  fields->millisOfDay_ = OrgJodaTimeChronoBasicChronology_cMillisOfDayField;
  fields->secondOfMinute_ = OrgJodaTimeChronoBasicChronology_cSecondOfMinuteField;
  fields->secondOfDay_ = OrgJodaTimeChronoBasicChronology_cSecondOfDayField;
  fields->minuteOfHour_ = OrgJodaTimeChronoBasicChronology_cMinuteOfHourField;
  fields->minuteOfDay_ = OrgJodaTimeChronoBasicChronology_cMinuteOfDayField;
  fields->hourOfDay_ = OrgJodaTimeChronoBasicChronology_cHourOfDayField;
  fields->hourOfHalfday_ = OrgJodaTimeChronoBasicChronology_cHourOfHalfdayField;
  fields->clockhourOfDay_ = OrgJodaTimeChronoBasicChronology_cClockhourOfDayField;
  fields->clockhourOfHalfday_ = OrgJodaTimeChronoBasicChronology_cClockhourOfHalfdayField;
  fields->halfdayOfDay_ = OrgJodaTimeChronoBasicChronology_cHalfdayOfDayField;
  fields->year_ = new_OrgJodaTimeChronoBasicYearDateTimeField_initWithOrgJodaTimeChronoBasicChronology_(self);
  fields->yearOfEra_ = new_OrgJodaTimeChronoGJYearOfEraDateTimeField_initWithOrgJodaTimeDateTimeField_withOrgJodaTimeChronoBasicChronology_(fields->year_, self);
  OrgJodaTimeDateTimeField *field = new_OrgJodaTimeFieldOffsetDateTimeField_initWithOrgJodaTimeDateTimeField_withInt_(fields->yearOfEra_, 99);
  fields->centuryOfEra_ = new_OrgJodaTimeFieldDividedDateTimeField_initWithOrgJodaTimeDateTimeField_withOrgJodaTimeDateTimeFieldType_withInt_(field, OrgJodaTimeDateTimeFieldType_centuryOfEra(), 100);
  ...
  fields->era_ = new_OrgJodaTimeChronoGJEraDateTimeField_initWithOrgJodaTimeChronoBasicChronology_(self);
  fields->dayOfWeek_ = new_OrgJodaTimeChronoGJDayOfWeekDateTimeField_initWithOrgJodaTimeChronoBasicChronology_withOrgJodaTimeDurationField_(self, fields->days_);
  fields->dayOfMonth_ = new_OrgJodaTimeChronoBasicDayOfMonthDateTimeField_initWithOrgJodaTimeChronoBasicChronology_withOrgJodaTimeDurationField_(self, fields->days_);
  fields->dayOfYear_ = new_OrgJodaTimeChronoBasicDayOfYearDateTimeField_initWithOrgJodaTimeChronoBasicChronology_withOrgJodaTimeDurationField_(self, fields->days_);
  fields->monthOfYear_ = new_OrgJodaTimeChronoGJMonthOfYearDateTimeField_initWithOrgJodaTimeChronoBasicChronology_(self);
  fields->weekyear_ = new_OrgJodaTimeChronoBasicWeekyearDateTimeField_initWithOrgJodaTimeChronoBasicChronology_(self);
  fields->weekOfWeekyear_ = new_OrgJodaTimeChronoBasicWeekOfWeekyearDateTimeField_initWithOrgJodaTimeChronoBasicChronology_withOrgJodaTimeDurationField_(self, fields->weeks_);
  ...
  fields->years_ = [((OrgJodaTimeDateTimeField *) nil_chk(fields->year_)) getDurationField];
  fields->months_ = [((OrgJodaTimeDateTimeField *) nil_chk(fields->monthOfYear_)) getDurationField];
  fields->weekyears_ = [((OrgJodaTimeDateTimeField *) nil_chk(fields->weekyear_)) getDurationField];
}
...
+ (void)initialize {
  if (self == [OrgJodaTimeChronoBasicChronology class]) {
    {
      OrgJodaTimeChronoBasicChronology_cMillisField = JreLoadStatic(OrgJodaTimeFieldMillisDurationField, INSTANCE);
      OrgJodaTimeChronoBasicChronology_cSecondsField = new_OrgJodaTimeFieldPreciseDurationField_initWithOrgJodaTimeDurationFieldType_withLong_(OrgJodaTimeDurationFieldType_seconds(), OrgJodaTimeDateTimeConstants_MILLIS_PER_SECOND);
      OrgJodaTimeChronoBasicChronology_cMinutesField = new_OrgJodaTimeFieldPreciseDurationField_initWithOrgJodaTimeDurationFieldType_withLong_(OrgJodaTimeDurationFieldType_minutes(), OrgJodaTimeDateTimeConstants_MILLIS_PER_MINUTE);
      OrgJodaTimeChronoBasicChronology_cHoursField = new_OrgJodaTimeFieldPreciseDurationField_initWithOrgJodaTimeDurationFieldType_withLong_(OrgJodaTimeDurationFieldType_hours(), OrgJodaTimeDateTimeConstants_MILLIS_PER_HOUR);
      OrgJodaTimeChronoBasicChronology_cHalfdaysField = new_OrgJodaTimeFieldPreciseDurationField_initWithOrgJodaTimeDurationFieldType_withLong_(OrgJodaTimeDurationFieldType_halfdays(), OrgJodaTimeDateTimeConstants_MILLIS_PER_DAY / 2);
      OrgJodaTimeChronoBasicChronology_cDaysField = new_OrgJodaTimeFieldPreciseDurationField_initWithOrgJodaTimeDurationFieldType_withLong_(OrgJodaTimeDurationFieldType_days(), OrgJodaTimeDateTimeConstants_MILLIS_PER_DAY);
      OrgJodaTimeChronoBasicChronology_cWeeksField = new_OrgJodaTimeFieldPreciseDurationField_initWithOrgJodaTimeDurationFieldType_withLong_(OrgJodaTimeDurationFieldType_weeks(), OrgJodaTimeDateTimeConstants_MILLIS_PER_WEEK);
      OrgJodaTimeChronoBasicChronology_cMillisOfSecondField = new_OrgJodaTimeFieldPreciseDateTimeField_initWithOrgJodaTimeDateTimeFieldType_withOrgJodaTimeDurationField_withOrgJodaTimeDurationField_(OrgJodaTimeDateTimeFieldType_millisOfSecond(), OrgJodaTimeChronoBasicChronology_cMillisField, OrgJodaTimeChronoBasicChronology_cSecondsField);
      OrgJodaTimeChronoBasicChronology_cMillisOfDayField = new_OrgJodaTimeFieldPreciseDateTimeField_initWithOrgJodaTimeDateTimeFieldType_withOrgJodaTimeDurationField_withOrgJodaTimeDurationField_(OrgJodaTimeDateTimeFieldType_millisOfDay(), OrgJodaTimeChronoBasicChronology_cMillisField, OrgJodaTimeChronoBasicChronology_cDaysField);
      OrgJodaTimeChronoBasicChronology_cSecondOfMinuteField = new_OrgJodaTimeFieldPreciseDateTimeField_initWithOrgJodaTimeDateTimeFieldType_withOrgJodaTimeDurationField_withOrgJodaTimeDurationField_(OrgJodaTimeDateTimeFieldType_secondOfMinute(), OrgJodaTimeChronoBasicChronology_cSecondsField, OrgJodaTimeChronoBasicChronology_cMinutesField);
      OrgJodaTimeChronoBasicChronology_cSecondOfDayField = new_OrgJodaTimeFieldPreciseDateTimeField_initWithOrgJodaTimeDateTimeFieldType_withOrgJodaTimeDurationField_withOrgJodaTimeDurationField_(OrgJodaTimeDateTimeFieldType_secondOfDay(), OrgJodaTimeChronoBasicChronology_cSecondsField, OrgJodaTimeChronoBasicChronology_cDaysField);
      OrgJodaTimeChronoBasicChronology_cMinuteOfHourField = new_OrgJodaTimeFieldPreciseDateTimeField_initWithOrgJodaTimeDateTimeFieldType_withOrgJodaTimeDurationField_withOrgJodaTimeDurationField_(OrgJodaTimeDateTimeFieldType_minuteOfHour(), OrgJodaTimeChronoBasicChronology_cMinutesField, OrgJodaTimeChronoBasicChronology_cHoursField);
      OrgJodaTimeChronoBasicChronology_cMinuteOfDayField = new_OrgJodaTimeFieldPreciseDateTimeField_initWithOrgJodaTimeDateTimeFieldType_withOrgJodaTimeDurationField_withOrgJodaTimeDurationField_(OrgJodaTimeDateTimeFieldType_minuteOfDay(), OrgJodaTimeChronoBasicChronology_cMinutesField, OrgJodaTimeChronoBasicChronology_cDaysField);
      OrgJodaTimeChronoBasicChronology_cHourOfDayField = new_OrgJodaTimeFieldPreciseDateTimeField_initWithOrgJodaTimeDateTimeFieldType_withOrgJodaTimeDurationField_withOrgJodaTimeDurationField_(OrgJodaTimeDateTimeFieldType_hourOfDay(), OrgJodaTimeChronoBasicChronology_cHoursField, OrgJodaTimeChronoBasicChronology_cDaysField);
      ...
      OrgJodaTimeChronoBasicChronology_cClockhourOfDayField = new_OrgJodaTimeFieldZeroIsMaxDateTimeField_initWithOrgJodaTimeDateTimeField_withOrgJodaTimeDateTimeFieldType_(OrgJodaTimeChronoBasicChronology_cHourOfDayField, OrgJodaTimeDateTimeFieldType_clockhourOfDay());
      OrgJodaTimeChronoBasicChronology_cClockhourOfHalfdayField = new_OrgJodaTimeFieldZeroIsMaxDateTimeField_initWithOrgJodaTimeDateTimeField_withOrgJodaTimeDateTimeFieldType_(OrgJodaTimeChronoBasicChronology_cHourOfHalfdayField, OrgJodaTimeDateTimeFieldType_clockhourOfHalfday());
      OrgJodaTimeChronoBasicChronology_cHalfdayOfDayField = new_OrgJodaTimeChronoBasicChronology_HalfdayField_init();
    }
...
void OrgJodaTimeChronoBasicChronology_initWithOrgJodaTimeChronology_withId_withInt_(OrgJodaTimeChronoBasicChronology *self, OrgJodaTimeChronology *base, id param, jint minDaysInFirstWeek) {
  ...
  self->iYearInfoCache_ = [IOSObjectArray newArrayWithLength:OrgJodaTimeChronoBasicChronology_CACHE_SIZE type:OrgJodaTimeChronoBasicChronology_YearInfo_class_()];
...
OrgJodaTimeChronoBasicChronology_YearInfo *OrgJodaTimeChronoBasicChronology_getYearInfoWithInt_(OrgJodaTimeChronoBasicChronology *self, jint year) {
  ...
  if (info == nil || info->iYear_ != year) {
    info = new_OrgJodaTimeChronoBasicChronology_YearInfo_initWithInt_withLong_(year, [self calculateFirstDayOfYearMillisWithInt:year]);
    (void) IOSObjectArray_Set(self->iYearInfoCache_, year & OrgJodaTimeChronoBasicChronology_CACHE_MASK, info);
  }
  return info;
}
