...
#pragma push_macro("INCLUDE_ALL_DateTime")
#ifdef RESTRICT_DateTime
#define INCLUDE_ALL_DateTime 0
#else
#define INCLUDE_ALL_DateTime 1
#endif
#undef RESTRICT_DateTime

#if !defined (OrgJodaTimeDateTime_) && (INCLUDE_ALL_DateTime || defined(INCLUDE_OrgJodaTimeDateTime))
...
#if !defined (OrgJodaTimeDateTime_Property_) && (INCLUDE_ALL_DateTime || defined(INCLUDE_OrgJodaTimeDateTime_Property))
...
#pragma pop_macro("INCLUDE_ALL_DateTime")
