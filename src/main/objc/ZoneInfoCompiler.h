...
#pragma push_macro("INCLUDE_ALL_ZoneInfoCompiler")
#ifdef RESTRICT_ZoneInfoCompiler
#define INCLUDE_ALL_ZoneInfoCompiler 0
#else
#define INCLUDE_ALL_ZoneInfoCompiler 1
#endif
#undef RESTRICT_ZoneInfoCompiler

#if !defined (OrgJodaTimeTzZoneInfoCompiler_) && (INCLUDE_ALL_ZoneInfoCompiler || defined(INCLUDE_OrgJodaTimeTzZoneInfoCompiler))
...
#if !defined (OrgJodaTimeTzZoneInfoCompiler_DateTimeOfYear_) && (INCLUDE_ALL_ZoneInfoCompiler || defined(INCLUDE_OrgJodaTimeTzZoneInfoCompiler_DateTimeOfYear))
...
#pragma pop_macro("INCLUDE_ALL_ZoneInfoCompiler")
