...
#pragma push_macro("INCLUDE_ALL_DateTimeFieldType")
#ifdef RESTRICT_DateTimeFieldType
#define INCLUDE_ALL_DateTimeFieldType 0
#else
#define INCLUDE_ALL_DateTimeFieldType 1
#endif
#undef RESTRICT_DateTimeFieldType

#if !defined (OrgJodaTimeDateTimeFieldType_) && (INCLUDE_ALL_DateTimeFieldType || defined(INCLUDE_OrgJodaTimeDateTimeFieldType))
...
#pragma pop_macro("INCLUDE_ALL_DateTimeFieldType")
