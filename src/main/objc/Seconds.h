...
#pragma push_macro("INCLUDE_ALL_Seconds")
#ifdef RESTRICT_Seconds
#define INCLUDE_ALL_Seconds 0
#else
#define INCLUDE_ALL_Seconds 1
#endif
#undef RESTRICT_Seconds

#if !defined (OrgJodaTimeSeconds_) && (INCLUDE_ALL_Seconds || defined(INCLUDE_OrgJodaTimeSeconds))
...
#pragma pop_macro("INCLUDE_ALL_Seconds")
