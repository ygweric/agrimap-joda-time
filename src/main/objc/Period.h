...
#pragma push_macro("INCLUDE_ALL_Period")
#ifdef RESTRICT_Period
#define INCLUDE_ALL_Period 0
#else
#define INCLUDE_ALL_Period 1
#endif
#undef RESTRICT_Period

#if !defined (OrgJodaTimePeriod_) && (INCLUDE_ALL_Period || defined(INCLUDE_OrgJodaTimePeriod))
...
#pragma pop_macro("INCLUDE_ALL_Period")
