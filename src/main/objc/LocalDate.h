...
#pragma push_macro("INCLUDE_ALL_LocalDate")
#ifdef RESTRICT_LocalDate
#define INCLUDE_ALL_LocalDate 0
#else
#define INCLUDE_ALL_LocalDate 1
#endif
#undef RESTRICT_LocalDate

#if !defined (OrgJodaTimeLocalDate_) && (INCLUDE_ALL_LocalDate || defined(INCLUDE_OrgJodaTimeLocalDate))
...
#if !defined (OrgJodaTimeLocalDate_Property_) && (INCLUDE_ALL_LocalDate || defined(INCLUDE_OrgJodaTimeLocalDate_Property))
...
#pragma pop_macro("INCLUDE_ALL_LocalDate")
