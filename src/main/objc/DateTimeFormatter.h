...
#pragma push_macro("INCLUDE_ALL_DateTimeFormatter")
#ifdef RESTRICT_DateTimeFormatter
#define INCLUDE_ALL_DateTimeFormatter 0
#else
#define INCLUDE_ALL_DateTimeFormatter 1
#endif
#undef RESTRICT_DateTimeFormatter

#if !defined (OrgJodaTimeFormatDateTimeFormatter_) && (INCLUDE_ALL_DateTimeFormatter || defined(INCLUDE_OrgJodaTimeFormatDateTimeFormatter))
...
#pragma pop_macro("INCLUDE_ALL_DateTimeFormatter")
