...
#pragma push_macro("INCLUDE_ALL_EthiopicChronology")
#ifdef RESTRICT_EthiopicChronology
#define INCLUDE_ALL_EthiopicChronology 0
#else
#define INCLUDE_ALL_EthiopicChronology 1
#endif
#undef RESTRICT_EthiopicChronology

#if !defined (OrgJodaTimeChronoEthiopicChronology_) && (INCLUDE_ALL_EthiopicChronology || defined(INCLUDE_OrgJodaTimeChronoEthiopicChronology))
...
#pragma pop_macro("INCLUDE_ALL_EthiopicChronology")
