...
#pragma push_macro("INCLUDE_ALL_Days")
#ifdef RESTRICT_Days
#define INCLUDE_ALL_Days 0
#else
#define INCLUDE_ALL_Days 1
#endif
#undef RESTRICT_Days

#if !defined (OrgJodaTimeDays_) && (INCLUDE_ALL_Days || defined(INCLUDE_OrgJodaTimeDays))
...
#pragma pop_macro("INCLUDE_ALL_Days")
